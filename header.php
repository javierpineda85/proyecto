...
<body>
  ...
  <a class="navbar-brand" href="#"><img src="img/header/asa.png" alt="asa" width="100px"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#" tabindex="-1">Nosotros</a>
      </li>
      <li class="nav-item">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <button class="btn my-2 my-sm-0" type="submit"><!--<img src="img/header/asa-finder.png" alt="asa-finder" width="20px">--><i class="fas fa-search fa-lg"></i></button>
    </form>
  </div>
</nav>
