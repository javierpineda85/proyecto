  ...
  <body>
    <div class="container">
      <section class="titulo">
        <h1 id="blanco">Asociación Solidaria</h1><h1 id="naranja"> de Arquitectos</h1>
        <h3 id="blanco">Construimos la casa,</h3><h3 id="naranja"> tú la conviertes en un hogar</h3>
      </section>
      <section class="somos">
    ...
    <section class="vision">
      ...
      <section class="enfoque">
        <h2 id="blanco">NUESTRO</h2> <h2 id="naranja"> ENFOQUE</h2>
